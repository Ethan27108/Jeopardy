...
void initialize_game(void)
{
    ...
    strcpy(questions[2].question, "What Pokemon is in this picture?");
    ...
    strcpy(questions[5].question, "What video game is this?");
...
void mark_questions_answered(char *category, int value)
{
    for (int i = 0; i < NUM_QUESTIONS; i++)
    {
        if (strcmp(questions[i].category, category) == 0 && questions[i].value == value)
